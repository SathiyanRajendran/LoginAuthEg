...
namespace LoginAuthEg.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Pid,Pname,Price,Pimage")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Pid,Pname,Price,Pimage")] Product product)
        {
            if (id != product.Pid)
            {
                return NotFound();
